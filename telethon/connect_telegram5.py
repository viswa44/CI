...
chat_username_or_id = '+916364539426'  # Replace with the correct username or ID
...
async def process_images():
    ...
    while True:
        ...
        # Send the extracted text as plain text without any metadata
        await client.send_message(event.chat_id, f"Extracted text: {extracted_text}", parse_mode=None)
